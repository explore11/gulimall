...
import com.song.gulimall.gulimallsearch.feign.ProductFeignService;
import com.song.gulimall.gulimallsearch.service.MallSearchService;
import com.song.gulimall.gulimallsearch.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchResult buildSearchResult(SearchResponse response, SearchParam param) {
        ...
        //5、2分页信息-总页码-计算
        int totalPages = (int) total % ElasticSearchConstant.PRODUCT_PAGE_SIZE == 0 ?
                (int) total / ElasticSearchConstant.PRODUCT_PAGE_SIZE : ((int) total / ElasticSearchConstant.PRODUCT_PAGE_SIZE + 1);
    ...
    private SearchRequest buildSearchRequest(SearchParam param)  {
        ...
        //分页
        searchSourceBuilder.from((param.getPageNum() - 1) * ElasticSearchConstant.PRODUCT_PAGE_SIZE);
